...
public sealed class TransmuteIgnore
{
    ...
    /// <summary>
    /// Parses ignore rules from <paramref name="ignoreContents"/>.
    /// Returns <see cref="Empty"/> if content is empty or null.
    /// </summary>
    public static TransmuteIgnore Load(string ignoreContents)
    {
        TransmuteIgnore instance = new TransmuteIgnore();
    ...
    public bool IsIgnored(string relativePath, bool isDirectory)
    {
        ...
        bool ignored = false;
        foreach (IgnorePattern p in _patterns)
        {
